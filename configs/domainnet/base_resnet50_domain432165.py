...
dataset = dict(type='DomainNet', root='./data/DomainNet',
               ann_files = dict(
                   train_anns=['quickdraw_train.txt', 'painting_train.txt', 'infograph_train.txt', 'clipart_train.txt', 'sketch_train.txt', 'real_train.txt'],
                   test_anns=['quickdraw_test.txt', 'painting_test.txt', 'infograph_test.txt', 'clipart_test.txt', 'sketch_test.txt', 'real_test.txt'])
               )
