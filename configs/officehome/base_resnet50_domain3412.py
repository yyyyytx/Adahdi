...
dataset = dict(type='OfficeHome', root='./data/officehome',
               ann_files = dict(
                   train_anns=['domain3_train.txt', 'domain4_train.txt', 'domain1_train.txt', 'domain2_train.txt'],
                   test_anns=['domain3_test.txt', 'domain4_test.txt', 'domain1_test.txt', 'domain2_test.txt']),
               kwargs=dict())
