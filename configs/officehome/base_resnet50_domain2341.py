...
dataset = dict(type='OfficeHome', root='./data/officehome',
               ann_files = dict(
                   train_anns=['domain2_train.txt', 'domain3_train.txt', 'domain4_train.txt', 'domain1_train.txt'],
                   test_anns=['domain2_test.txt', 'domain3_test.txt', 'domain4_test.txt', 'domain1_test.txt']),
               kwargs=dict())
