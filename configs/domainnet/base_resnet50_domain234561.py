...
dataset = dict(type='DomainNet', root='./data/DomainNet',
               ann_files = dict(
                   train_anns=['infograph_train.txt', 'painting_train.txt', 'quickdraw_train.txt', 'real_train.txt', 'sketch_train.txt', 'clipart_train.txt'],
                   test_anns=['infograph_test.txt', 'painting_test.txt', 'quickdraw_test.txt', 'real_test.txt', 'sketch_test.txt', 'clipart_test.txt'])
               )
